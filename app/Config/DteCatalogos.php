...
class DteCatalogos extends BaseConfig
{
    ...
    // CAT-025 Título a que se remiten los bienes (Notas de remisión)		
    public $bienTitulo = [
        '01' => 'Depósito',
        '02' => 'Propiedad',
        '03' => 'Consignación',
    ...
    // CAT-026 Tipo de Donación	(Comprobantes electronicos de donación)	
    public $tipoDonacion = [
        1 => 'Efectivo',
        2 => 'Bien',
        3 => 'Servicio'
