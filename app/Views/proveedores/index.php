    ...
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <div class="card-header d-flex">
                ...
                <?php if (tienePermiso('crear_proveedor')): ?>
                    <a class="btn btn-primary btn-sm ml-auto"
                       href="<?= base_url('proveedores/new') ?>">
            ...
            <div class="card-body">
                ...
                <div class="row mb-3 align-items-end">
                    ...
                    <div class="col-md-10">
                        ...
                        <label for="searchInput">Buscar proveedor</label>
                ...
                <div id="table-container">
                    <?= $this->include('proveedores/_proveedor_table') ?>
                </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const baseUrl = '<?= base_url('proveedores-search') ?>';
    ...
    function rebindEvents() {
        ...
        document.querySelectorAll('#pagination-links a')
        .forEach(link => {
    ...
    function handleDelete() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                fetch("<?= base_url('proveedores/delete') ?>", {
