...
<div class="row g-3 mb-3">
    <div class="col-12">
        <h4 class="mb-0"><i class="fa-solid fa-book-open-reader me-2"></i>Contabilidad — Dashboard</h4>
...
<div class="row g-3">
    ...
    <div class="col-md-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-header bg-white fw-semibold"><i class="fa-solid fa-calendar me-2 text-primary"></i>Período Actual</div>
            <div class="card-body">
    ...
    <div class="col-md-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-header bg-white fw-semibold"><i class="fa-solid fa-scale-balanced me-2 text-success"></i>Saldos por Tipo (Período Actual)</div>
            <div class="card-body p-0">
                <?php if (!empty($saldosPorTipo)): ?>
                <table class="table table-sm mb-0">
                    <thead class="table-light">
                        <tr><th>Tipo</th><th class="text-end">Saldo</th></tr>
                    </thead>
                    <tbody>
                        <?php
    ...
    <div class="col-md-4">
        <div class="card border-0 shadow-sm h-100">
            <div class="card-header bg-white fw-semibold d-flex justify-content-between">
                <span><i class="fa-solid fa-clock-rotate-left me-2 text-info"></i>Últimos Asientos</span>
...
<div class="row g-3 mt-1">
    <div class="col-12"><h6 class="text-muted fw-semibold">ACCESOS RÁPIDOS</h6></div>
    <?php
    $accesos = [
