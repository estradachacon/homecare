                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="text-end border rounded px-3 py-2 bg-light h-100">
                            ...
                            <?php $saldo = $compra->saldo ?? 0; ?>

                            <div class="d-flex align-items-center">
                                <small class="text-muted">Estado</small>

                                <?php if (($compra->anulada ?? 0) == 1): ?>
                                    <span class="badge text-dark px-3 py-1 ml-auto" style="background:#e65220;">
                                        Anulada
                                    </span>
                                <?php elseif ($saldo == 0): ?>
                                    <span class="badge text-white px-3 py-1 ml-auto" style="background:#15913a;">
                                        Pagada
                                    </span>
                                <?php else: ?>
                                    <span class="badge text-dark px-3 py-1 ml-auto" style="background:#fdda11;">
                                        Activa
                                    </span>
                                <?php endif; ?>
                            </div>
                            ...
                            <div class="mt-2 d-flex align-items-center">
                                ...
                                <span class="fw-bold fs-5 ml-auto <?= $saldo > 0 ? 'text-danger' : 'text-success' ?>">
