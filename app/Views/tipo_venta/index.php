    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header d-flex">
                <h4 class="header-title">Tipos de ventas</h4>
                <?php if (tienePermiso('crear_tipo_venta')): ?>
                    <a class="btn btn-primary btn-sm ml-auto" href="<?= base_url('tipo_venta/new') ?>"><i
            ...
            <div class="card-body">
                ...
                <div class="row mb-3 align-items-end">
                    ...
                    <div class="col-md-10">
                        <label for="searchInput">Buscar tipo de venta</label>
                        <div class="input-group">
                            <input type="text" id="searchInput" class="form-control" placeholder="Escriba para buscar..." aria-label="Buscar" aria-describedby="loading-spinner"
                                value="<?= esc($q ?? '') ?>">
                ...
                <div id="table-container">
                    <?= $this->include('tipo_venta/_tipo_venta_table') ?>
                </div>
