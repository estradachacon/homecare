...
<head>
    ...
    <style>
        ...
        .header h1 { margin: 0; font-size: 18pt; font-weight: 500; }
        .header p { margin: 5px 0 0; font-size: 11pt; opacity: 0.9; }
        .card {
        ...
        .card h2 { font-size: 14pt; color: #1a73e8; border-bottom: 2px solid #e0e0e0; padding-bottom: 5px; margin: 0 0 15px 0; }
        .info-row { display: flex; padding: 5px 0; }
        .info-label { font-weight: bold; width: 35%; color: #555; }
        .info-value { width: 65%; }
        .table-section h2 { font-size: 14pt; color: #1a73e8; margin-bottom: 10px; }
        table {
            width: 100%;
        ...
        th { background-color: #1a73e8; color: #fff; text-align: left; font-weight: 600; }
        tr:nth-child(even) { background-color: #f4f4f9; }
        .status { padding: 4px 8px; border-radius: 4px; font-weight: bold; font-size: 9pt; display: inline-block; }
        .status-entregado { background-color: #e6ffed; color: #00891d; }
        .status-no_retirado { background-color: #ffebe6; color: #d93025; }
        .status-recolectado { background-color: #fff4e5; color: #e37400; }
        .status-otro { background-color: #f0f0f0; color: #5f6368; }
        .footer { text-align: center; font-size: 8pt; color: #777; margin-top: 20px; border-top: 1px solid #e0e0e0; padding-top: 8px; }
    </style>
</head>
<body>
<div class="container">
